...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    return new Response(JSON.stringify({success: false, error}), {status: 500, headers: { "Content-Type": "application/json" }});
  };
};