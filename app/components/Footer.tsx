      ...
      <div className="max-w-6xl mx-auto px-4 py-12 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2 text-gray-700">
            <li><Link href="/world" className="hover:underline">World</Link></li>
            <li><Link href="/politics" className="hover:underline">Politics</Link></li>
            {/* <li><Link href="/palestine" className="hover:underline">Palestine</Link></li> */}
        ...
        <div className="md:col-span-1">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-2">
            ...
            <button type="submit" className="inline-block border border-black px-6 py-3 text-sm font-medium hover:bg-black hover:text-white transition cursor-pointer">Subscribe</button>
          </form>
